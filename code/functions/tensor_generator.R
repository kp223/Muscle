...
summarized_hic=qs::qread(paste0(dir_data,"/summarized_hic_",chrlist[chr],".qs"))#qs::qread(paste0(dir_data,'/summarized_hic.qs'))
...
fitted=qs::qread(paste0(dir_data,"/Matricized_HiCtensor_imputed_",chrlist[chr],".qs"))
